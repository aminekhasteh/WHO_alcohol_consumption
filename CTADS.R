  ...
  if(N > 0){ # Changing N_all-->N since 11904 individuals selected 6 (valid skip) for ALC_Q20
    ...
    if(length(tmp_tmp_dat6$DVAGE) > 0){
      ...
      a1 <- 13.6 * (as.numeric(tmp_tmp_dat6[which(tmp_tmp_dat6$ALC_10==1),]$ALC_40)*
                      as.numeric(tmp_tmp_dat6[which(tmp_tmp_dat6$ALC_10==1),]$ALC_10)*365)/365 # Drank alcoholic beverages Daily or almost daily in the last 12 month
      a2 <- 13.6 * (as.numeric(tmp_tmp_dat6[which(tmp_tmp_dat6$ALC_10==2),]$ALC_40)*
                      as.numeric(tmp_tmp_dat6[which(tmp_tmp_dat6$ALC_10==2),]$ALC_10)*234)/365 # Drank alcoholic beverages 4 to 5 times a week in the last 12 month
      a3 <- 13.6 * (as.numeric(tmp_tmp_dat6[which(tmp_tmp_dat6$ALC_10==3),]$ALC_40)*
                      as.numeric(tmp_tmp_dat6[which(tmp_tmp_dat6$ALC_10==3),]$ALC_10)*130)/365 # Drank alcoholic beverages 2 to 3 times a week in the last 12 month
      a4 <- 13.6 * (as.numeric(tmp_tmp_dat6[which(tmp_tmp_dat6$ALC_10==4),]$ALC_40)*
                      as.numeric(tmp_tmp_dat6[which(tmp_tmp_dat6$ALC_10==4),]$ALC_10)*52)/365 # Drank alcoholic beverages Once a week in the last 12 month
      a5 <- 13.6 * (as.numeric(tmp_tmp_dat6[which(tmp_tmp_dat6$ALC_10==5),]$ALC_40)*
                      as.numeric(tmp_tmp_dat6[which(tmp_tmp_dat6$ALC_10==5),]$ALC_10)*30)/365 # Drank alcoholic beverages 2 to 3 times a month  in the last 12 month
      a6 <- 13.6 * (as.numeric(tmp_tmp_dat6[which(tmp_tmp_dat6$ALC_10==6),]$ALC_40)*
                      as.numeric(tmp_tmp_dat6[which(tmp_tmp_dat6$ALC_10==6),]$ALC_10)*12)/365 # Drank alcoholic beverages Once a month  in the last 12 month
      a7 <- 13.6 * (as.numeric(tmp_tmp_dat6[which(tmp_tmp_dat6$ALC_10==7),]$ALC_40)*
                      as.numeric(tmp_tmp_dat6[which(tmp_tmp_dat6$ALC_10==7),]$ALC_10)*6)/365 # Drank alcoholic beverages Less than once a month  in the last 12 month
